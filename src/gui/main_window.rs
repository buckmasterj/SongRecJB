...
pub fn gui_main(
    ...
    let application = gtk::Application::new(
        Some("com.github.marinm.songrec"),
    ...
    application.connect_startup(move |application| {
        ...
        let buttons_frame: gtk::Frame = builder.get_object("buttons_frame").unwrap();
        let fbc2: gtk::FlowBoxChild = builder.get_object("fbc2").unwrap();
